...
def missing_digits(n, miss_digit=0):
    ...
    if n // 10 == 0:
        ...
        new_miss_digit = 0
        last_last, last = n // 10 % 10, n % 10
        if last != last_last:
            new_miss_digit = last - last_last - 1
    return missing_digits(n // 10, miss_digit + new_miss_digit)
    



def count_change(total, change=1):
    ...
    if total == 0:
        ...
        return 0
    return count_change(total - change, change) + count_change(total, change * 2)
