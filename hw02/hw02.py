...
def accumulate(combiner, base, n, term):
    ...
    """
    "*** YOUR CODE HERE ***"
    accumulate_result = base
    while n:
        accumulate_result = combiner(accumulate_result, term(n))
        n -= 1
...
def myAccumulate(combiner, base, n, term):
    """Return the function that computes the nth application of f.

    >>> myAccumulate(compose1, lambda x: x, 3, increment)(5)  # increment(increment(increment(x))), x == 5
    8
    "*** YOUR CODE HERE ***"
    """
    if not n:
        return base
    return combiner(term, myAccumulate(combiner, base, n - 1, term))
