...
class ProfessorCard(Card):
    ...
    """Implement the effect method for the Professor, 
    who adds the opponent card 's attack and defense to all cards in the player' s deck 
    and then removes all cards in the opponent 's deck that 
    have the same attack or defense as the opponent' s card.
    """
    ...
    def effect(self, other_card, player, opponent):
        ...
        "*** YOUR CODE HERE ***"
        attack_and_defense = other_card.attack + other_card.defense 
        ...
        if discarded:
            ...
            for card in player.deck.cards:
                card.attack = card.defense = attack_and_defense
