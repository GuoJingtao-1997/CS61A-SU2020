...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 11
    return 0 if is_swap(score + free_bacon(opponent_score),opponent_score) and (score + free_bacon(opponent_score)) > opponent_score or free_bacon(opponent_score) >= margin else num_rolls
    # END PROBLEM 11
